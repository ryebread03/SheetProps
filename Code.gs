...
/* NASA 7-term ideal-gas cp polynomials (GRI-Mech 3.0, extracted via
 * Cantera). Used for T >= 298.15 K; the cubic fits above remain in
 * use below that, preserving cryogenic behavior and reference states.
 * Two ranges split at Tmid (1000 K), valid to 3500 K. AIR is a
 * mole-weighted N2/O2/Ar combination (valid: the form is linear). */
var NASA_CP0 = {
  AIR: {Tmid: 1000.0, lo: [3.3925884839144005,0.0004720690653616,-1.0323483054645997e-06,2.3780816236414e-09,-1.2300335138302003e-12,-1027.3458659504001,3.8929223891042004], hi: [2.9972300157936003,0.0014730546011476001,-6.0287230894226e-07,1.2276244332030002e-10,-9.816282188596e-15,-955.8529725727999,5.8549585558666]},
  AMMONIA: {Tmid: 1000.0, lo: [4.2860274,-0.004660523,2.1718513e-05,-2.2808887e-08,8.2638046e-12,-6741.7285,-0.62537277], hi: [2.6344521,0.005666256,-1.7278676e-06,2.3867161e-10,-1.2578786e-14,-6544.6958,6.5662928]},
  ARGON: {Tmid: 1000.0, lo: [2.5,0.0,0.0,0.0,0.0,-745.375,4.366], hi: [2.5,0.0,0.0,0.0,0.0,-745.375,4.366]},
  CO: {Tmid: 1000.0, lo: [3.57953347,-0.00061035368,1.01681433e-06,9.07005884e-10,-9.04424499e-13,-14344.086,3.50840928], hi: [2.71518561,0.00206252743,-9.98825771e-07,2.30053008e-10,-2.03647716e-14,-14151.8724,7.81868772]},
  CO2: {Tmid: 1000.0, lo: [2.35677352,0.00898459677,-7.12356269e-06,2.45919022e-09,-1.43699548e-13,-48371.9697,9.90105222], hi: [3.85746029,0.00441437026,-2.21481404e-06,5.23490188e-10,-4.72084164e-14,-48759.166,2.27163806]},
  ETHANE: {Tmid: 1000.0, lo: [4.29142492,-0.0055015427,5.99438288e-05,-7.08466285e-08,2.68685771e-11,-11522.2055,2.66682316], hi: [1.0718815,0.0216852677,-1.00256067e-05,2.21412001e-09,-1.9000289e-13,-11426.3932,15.1156107]},
  ETHYLENE: {Tmid: 1000.0, lo: [3.95920148,-0.00757052247,5.70990292e-05,-6.91588753e-08,2.69884373e-11,5089.77593,4.09733096], hi: [2.03611116,0.0146454151,-6.71077915e-06,1.47222923e-09,-1.25706061e-13,4939.88614,10.3053693]},
  HYDROGEN: {Tmid: 1000.0, lo: [2.34433112,0.00798052075,-1.9478151e-05,2.01572094e-08,-7.37611761e-12,-917.935173,0.683010238], hi: [3.3372792,-4.94024731e-05,4.99456778e-07,-1.79566394e-10,2.00255376e-14,-950.158922,-3.20502331]},
  METHANE: {Tmid: 1000.0, lo: [5.14987613,-0.0136709788,4.91800599e-05,-4.84743026e-08,1.66693956e-11,-10246.6476,-4.64130376], hi: [0.074851495,0.0133909467,-5.73285809e-06,1.22292535e-09,-1.0181523e-13,-9468.34459,18.437318]},
  METHANOL: {Tmid: 1000.0, lo: [5.71539582,-0.0152309129,6.52441155e-05,-7.10806889e-08,2.61352698e-11,-25642.7656,-1.50409823], hi: [1.78970791,0.0140938292,-6.36500835e-06,1.38171085e-09,-1.1706022e-13,-25374.8747,14.5023623]},
  NITROGEN: {Tmid: 1000.0, lo: [3.298677,0.0014082404,-3.963222e-06,5.641515e-09,-2.444854e-12,-1020.8999,3.950372], hi: [2.92664,0.0014879768,-5.68476e-07,1.0097038e-10,-6.753351e-15,-922.7977,5.980528]},
  OXYGEN: {Tmid: 1000.0, lo: [3.78245636,-0.00299673416,9.84730201e-06,-9.68129509e-09,3.24372837e-12,-1063.94356,3.65767573], hi: [3.28253784,0.00148308754,-7.57966669e-07,2.09470555e-10,-2.16717794e-14,-1088.45772,5.45323129]},
  PROPANE: {Tmid: 1000.0, lo: [0.93355381,0.026424579,6.1059727e-06,-2.1977499e-08,9.5149253e-12,-13958.52,19.201691], hi: [7.5341368,0.018872239,-6.2718491e-06,9.1475649e-10,-4.7838069e-14,-16467.516,-17.892349]},
  WATER: {Tmid: 1000.0, lo: [4.19864056,-0.0020364341,6.52040211e-06,-5.48797062e-09,1.77197817e-12,-30293.7267,-0.849032208], hi: [3.03399249,0.00217691804,-1.64072518e-07,-9.7041987e-11,1.68200992e-14,-30004.2971,4.9667701]}
};
(function(){ for (var k in NASA_CP0) if (FLUID_DB[k]) FLUID_DB[k].nasa = NASA_CP0[k]; })();
...
function _nasaA(n, T) { return (T < n.Tmid) ? n.lo : n.hi; }
function _nasaCp(n, T) {           // cp0 [J/mol-K]
  T = Math.min(T, 3500);
  var a = _nasaA(n, T);
  return RGAS * (a[0] + a[1]*T + a[2]*T*T + a[3]*T*T*T + a[4]*T*T*T*T);
}
function _nasaH(n, T) {            // absolute h0 [J/mol] (a6 term incl.)
  T = Math.min(T, 3500);
  var a = _nasaA(n, T);
  return RGAS * T * (a[0] + a[1]/2*T + a[2]/3*T*T + a[3]/4*T*T*T + a[4]/5*T*T*T*T + a[5]/T);
}
function _nasaS(n, T) {            // absolute s0 at PREF0 [J/mol-K]
  T = Math.min(T, 3500);
  var a = _nasaA(n, T);
  return RGAS * (a[0]*Math.log(T) + a[1]*T + a[2]/2*T*T + a[3]/3*T*T*T + a[4]/4*T*T*T*T + a[6]);
}

function _cp0(f, T) {
  if (f.nasa && T >= TREF0) return _nasaCp(f.nasa, T);
  var c = f.cp;
  return c[0] + c[1] * T + c[2] * T * T + c[3] * T * T * T;
}
function _h0(f, T) {
  if (f.nasa && T >= TREF0) return _nasaH(f.nasa, T) - _nasaH(f.nasa, TREF0);
  var c = f.cp, t = TREF0;
...
function _s0(f, T, P) {
  if (f.nasa && T >= TREF0) {
    return _nasaS(f.nasa, T) - _nasaS(f.nasa, TREF0) - RGAS * Math.log(P / PREF0);
  }
  var c = f.cp, t = TREF0;
